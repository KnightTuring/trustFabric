...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
    ...
    //recordVote -  requires 5 args ID, Voter, Voted for, timestamp, Location- ex: ['1', 'Turing', 'CESA', '120865332', 'PCCOE']
    // send proposal to endorser
    const request = {
        //targets : --- letting this default to the peers assigned to the channel
        chaincodeId: 'voting-app',
        fcn: 'recordVote',
        //args: [key,voter,votedFor,timestamp,location],
        args: ['0',"Abdul","CESA","15024456","PCCOE"],
        chainId: 'mychannel',
        txId: tx_id
    };
